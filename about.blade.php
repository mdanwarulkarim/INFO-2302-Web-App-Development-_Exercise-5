    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-white-100 dark:bg-white-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <p>eBook reader or eBook apps are mobile software that helps you read books wherever you are, with just your phone screen.<br>
                 These apps have come a long way since the only ePub reader Android users could access was Google Play Books </p>
